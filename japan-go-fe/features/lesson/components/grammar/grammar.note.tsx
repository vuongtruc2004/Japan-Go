...
import { GrammarNoteResponse } from "@/types/api/responses/grammar.response";
import { useTranslations } from "next-intl";
import { DecoratorClassName } from "@/types/enums/share.enum";
import CircleNumber from "@/components/ui/circle.number";

const GrammarNote = ({ grammarNote }: { grammarNote: GrammarNoteResponse }) => {
    ...
    return (
        <div>
            ...
            <div className="flex flex-col gap-y-3">
                {grammarNote.sentences.map((sentence, index) => {
                    return (
