                ...
                <div className="flex flex-col gap-y-3">
                    {folders.map((folder) => {
                        return (
                            <div
                                key={folder.id}
                                className="bg-bgc-page border-bdc-primary group relative flex cursor-pointer items-center justify-between rounded-md border pr-4 transition-all duration-150"
                            >
                                <Link
